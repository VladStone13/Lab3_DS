...
public class FootballPlayer {
    ...
    public FootballPlayer(com.services.grpc.server.transferMarket.FootballPlayerResponse footballPlayerResponse) {
    ...
    public com.services.grpc.server.transferMarket.FootballPlayerRequest toRequest() {
        return com.services.grpc.server.transferMarket.FootballPlayerRequest.newBuilder().
                setAge(age).
                setId(id.toString()).
    ...
    public com.services.grpc.server.footballWorld.FootballPlayerRequest toRequestFW() {
        return com.services.grpc.server.footballWorld.FootballPlayerRequest.newBuilder().
                setAge(age).setId(id.toString()).
                setRatingScore(ratingScore).
                setName(name).
                setPosition(position).build();
    }
