...
public class FootballClub {
    ...
    public FootballClubRequest toRequest() {
        ...
        for(FootballPlayer footballPlayer:footballTeam) {
            footballPlayerRequests.add(footballPlayer.toRequestFW());
        }

        return FootballClubRequest.newBuilder().setClubName(clubName).
                setBudget(budget).setTrainer(trainer.toRequest()).setId(id.toString())
                .addAllFootballTeam(footballPlayerRequests).build();
    }
