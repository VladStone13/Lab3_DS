...
//            TransferMarketDTO footballPlayersDTO = new TransferMarketDTO();
...
//            System.out.println(footballPlayersJson);
//
...
//        }
    ...
    private static void fillTransferMarket(TransferMarket transferMarket) {
        ...
        ResponseEntity<Void> response1 = restTemplate
                .exchange(URL2 + "/rmq", HttpMethod.POST, deliverJson, Void.class);
        ...
        private static void printTransferMarket() {
            ...
            ResponseEntity<TransferMarketDTO> response2 = restTemplate
                    .exchange(URL2 + "/transferMarket", HttpMethod.GET, headersEntity, TransferMarketDTO.class);
